  ...
  data() {
    return {
      ...
      persons: [
        ...
        { uid: "a101", name: "김유신", age: 33 },
        { uid: "a101", name: "김유신", age: 45 },
        { uid: "a101", name: "김유신", age: 53 },
      ],
      value1: "tit1",
      value2: "tit2",
      count: 0,
...
<template>
  ...
  <p>count : {{ count }}</p>
  <button @click="countUp">countUp</button> <br />
  ...
  <a :href="link1">네이버</a> <br />

  <a :href="link2">다음</a> <br />
  ...
  <form @:submit.prevent="formUser2" method="post">
    ...
    나이 : <input type="number" v-model="myUser.age" /><br />
    <input type="submit" value="전송" />
  </form>
</template>
